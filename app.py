...
<style>
    ...
    @media (max-width: 1500px) and (min-width: 821px) {
        ...
        [data-testid="stHorizontalBlock"]:has(.card-desc) > [data-testid="stColumn"] [data-testid="stVerticalBlockBorderWrapper"] {min-height: 420px !important; height: auto !important;}
